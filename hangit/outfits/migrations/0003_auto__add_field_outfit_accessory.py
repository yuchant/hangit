...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Outfit.accessory'
        db.add_column(u'outfits_outfit', 'accessory',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='accessory', null=True, to=orm['outfits.Clothing']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Outfit.accessory'
        db.delete_column(u'outfits_outfit', 'accessory_id')
